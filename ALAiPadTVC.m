...
@interface ALAiPadTVC ()

@end

@implementation ALAiPadTVC
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return [[[ALAData MainData]allListItems] count];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    NSDictionary * listItem = [[ALAData MainData] allListItems][indexPath.row];
    NSLog(@"%@", listItem);
}
/*
